...
# ============================================================================
"""CascadeRcnn tpositive and negative sample screening for Rcnn."""
...
class BboxAssignSampleForRcnn_1_1(nn.Cell):
    """
    ...
    def __init__(self, config, batch_size, num_bboxes, add_gt_as_proposals):
        super(BboxAssignSampleForRcnn_1_1, self).__init__()
        cfg = config
        self.dtype = np.float32
        self.ms_type = mstype.float32
        self.batch_size = batch_size
        self.neg_iou_thr = cfg.neg_iou_thr_stage2_2
        self.pos_iou_thr = cfg.neg_iou_thr_stage2_2
        ...
        self.check_neg_mask = Tensor(np.array(np.ones(self.num_expected_neg - self.num_expected_pos), dtype=np.bool_))
    ...
    def construct(self, gt_bboxes_i, gt_labels_i, valid_mask, bboxes, gt_valids):
        ...
        overlaps = self.cast(self.logicalnot(self.greater(overlaps, 1.0)), mstype.int32) * overlaps
