...
class BboxAssignSampleForRcnn_2_1(nn.Cell):
    """
    ...
    def __init__(self, config, batch_size, num_bboxes, add_gt_as_proposals):
        super(BboxAssignSampleForRcnn_2_1, self).__init__()
        cfg = config
        self.dtype = np.float32
        self.ms_type = mstype.float32
        self.batch_size = batch_size
        self.neg_iou_thr = cfg.neg_iou_thr_stage2_3
        self.pos_iou_thr = cfg.neg_iou_thr_stage2_3
