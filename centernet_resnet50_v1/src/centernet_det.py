...
from src.resnet50 import Bottleneck, ResNet50, weights_init
...
class GatherDetectionFeatureCell(nn.Cell):
    ...
    def __init__(self, net_config):
        ...
        self.resnet50 = ResNet50(self.block_class, self.layers, heads, head_conv)

        weights_init(self.resnet50)
