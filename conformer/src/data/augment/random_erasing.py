...
class RandomErasing:
    ...
    probability:
     ...
     min_area:
        Minimum percentage of erased area wrt input image area.
     max_area:
        Maximum percentage of erased area wrt input image area.
     min_aspect:
    ...
    max_count:
        ...
        by count. per-image count is randomly chosen between 1 and this
        value.
    """

    def __init__(
            self, probability=0.5, min_area=0.02, max_area=1 / 3,
            min_aspect=0.3, max_aspect=None, mode='const', min_count=1,
    ...
    def _erase(self, img, chan, img_h, img_w, dtype):
        ...
        if random.random() > self.probability:
            ...
            area = img_h * img_w
            count = (
                self.min_count if self.min_count == self.max_count
