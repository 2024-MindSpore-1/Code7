...
class Generator(nn.Cell):
    ...
    def _decoder_stage(dc_inp, dc_inp_mask, ec_outputs, ec_outputs_masks, decoder):
        ...
        for i in range(6, -1, -1):
            ...
            dc_inp = ops.ResizeBilinearV2(align_corners=True)(dc_inp, (2 * h, 2 * w))  # align_corners = False
    ...
    def construct(self, input_image, input_edge, mask):
        ...
        output = ops.ResizeBilinearV2(align_corners=True)(output, (2 * h, 2 * w))  # align_corners = False
